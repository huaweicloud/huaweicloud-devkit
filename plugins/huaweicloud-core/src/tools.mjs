...
function serviceCatalog(intent = '') {
  ...
  const routeMap = [
    ...
    {
      keywords: ['waf', 'aad', 'ddos', 'firewall', 'web protection', 'Web应用防火墙', 'DDoS防护', '防火墙'],
      skills: ['huawei-waf-aad'],
      services: ['WAF', 'AAD'],
    },
    {
      keywords: ['smn', 'dms', 'notification', 'message', 'kafka', 'rabbitmq', '消息通知', '消息队列', '通知'],
    ...
    {
      keywords: ['cts', 'audit', 'trace', 'tracker', '云审计服务', '审计', '追踪'],
      skills: ['huawei-cts'],
      services: ['CTS'],
    },
    {
      keywords: ['cbr', 'backup', 'restore', 'vault', 'snapshot', '云备份', '备份', '恢复', '存储库', '快照'],
      skills: ['huawei-cbr'],
      services: ['CBR'],
    },
    {
      keywords: ['deployment', 'deploy', 'ci/cd', 'pipeline', 'release', '部署', '持续集成', '流水线', '发布'],
    ...
    {
      keywords: ['dds', 'dcs', 'mongodb', 'redis', 'memcached', 'cache', 'document db', '文档数据库', '缓存'],
